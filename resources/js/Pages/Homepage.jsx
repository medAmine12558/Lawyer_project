...
export default function Homepage({ cases, status }) {
    ...
    return (
        <div>
            ...
            <div id='statictics' className="flex flex-col items-center py-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-yellow-100 p-6 rounded shadow-md">
                        ...
                        <p className="text-gray-700 mt-2">We specialize in a wide range of legal areas, providing comprehensive expertise to meet the diverse needs of our clients. With significant experience in over five types of cases,</p>
                    </div>
                </div>
            </div>
